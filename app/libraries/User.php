...
class User {
	...
	public function login($email = null, $password = null, $remember = false,$type=null)
	{
	 if (!$email && !$password && $this->exists()) {
	  ...
	  if ($user) {
		 ...
		 // }
	  	...
	  	if ($type=='google_singin') {
	  		$password_check = 1;
	  	}

	  	if ($type=='facebook_singin') {
	  		$password_check = 1;
	  	}
	...
	public function google_login($email = null, $password = null, $remember = false)
	{
		$this->logout();
	 $user = $this->find($email);
