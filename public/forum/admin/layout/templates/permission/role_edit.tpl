...
<script type='text/javascript'>
    ...
    jQuery('docuement').ready(function ($) {
        ...
        var pHelps = {
            ...
            'edit profile': {
                granted: 'The users assigned to this role <b>can</b> edits <b>everyone\'s</b> profiles',
                denied:[
                    'The users assigned to this role <b>can</b> still edit thier own profiles',
                    'The users assigned to this role <b>cannot</b> edit others\' profiles'
                ]
            },
