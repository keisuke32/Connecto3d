        ...
        <div class="col-lg-12">
            <div class="box box-info">
                <div class="box-body">
                    ...
                    <label>Generated Page URL:(only alphabets, numbers and dashes are allowed)</label>



                    <div class="form-group" >

                        <span class="input-group-text no-radius form-control" >{$smarty.const.RURI}page/{$pid}/<span id="page_alias">{$current_page.url|default:''}</span></span>
