                        ...
                        <aside class="left-side sidebar-offcanvas">
                            ...
                            <section class="sidebar">
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="treeview {$active['ui/themes']}{$active['ui/blocks']}{$active['ui/smileys']}{$active['ui/roleColors']}">
                                        <a href="#">
                                        ...
                                        <ul class="treeview-menu">
                                            ...
                                            <li class="{$active['ui/roleColors']}"><a href="index.php?page=ui/roleColors"><i class="fa fa-user-circle-o"></i> Role Colors</a></li>
                                        </ul>
                                    </li>
