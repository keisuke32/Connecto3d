    ...
    <div class="col-lg-6">
        <div class="box box-info">
            <form class="box-body" action="?page=categories" role="form" method="post" enctype="multipart/form-data">
                ...
                <br/>
                <label>Category Icon[420x420]</label><br/>
                ...
                <br/>
                <label>Email all users on new topic? (Users that have explicitly unsubscribed will not be notified)</label><br/>
                <select class="form-control" name="default_subscription_type">
                    <option value="yes">Yes</option>
                    <option selected value="no">No (recommended)</option>
                </select>
                <br/>
