...
class Constants {
     ...
     * @param $path
     */
    public static function definePathConstants($path) {
     ...
     * @param $CONF
     */
    public static function defineConfigConstants($CONF) {
     ...
     * @param $views_dirA
     */
    public static function definePostBootConstants($views_dir) {
