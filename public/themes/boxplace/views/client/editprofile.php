		...
		<div class="col-lg-12">
         ...
         <div class="add-box">
           <form method="post" action="<?=$this->siteUrl()?>/<?=$this->client_url()?>/editprofile">
              ...
              <div class="form-group">	
			    <label><?=$this->lang('shipping_address')?></label>
			    <textarea name="shipping_address" class="form-control" rows="3" ><?php echo decrypt_text($data['user']['shipping_address']); ?></textarea>
              </div> 
