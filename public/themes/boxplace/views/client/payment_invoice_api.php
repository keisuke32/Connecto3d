		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<div class="add-box">
					...
					<?php foreach ($data['payment'] as $paymentVAL) { ?>
						...
						<div class="row" >
							...
							<div class="col-md-6 col-lg-6 col-xs-6 text-right">
								...
								<p>Invoice #<br/><?php echo $paymentVAL['uid'];  ?></p>
								<p>Date <br/><?php echo date('Y-m-d',strtotime($paymentVAL['created_at']));  ?></p>
						...
						<div class="row">
							...
							<div class="col-md-12 ">
								...
								<table class="table ">
									...
									<tr>
										<td>#<?php echo $data['jobs'][0]['job_id'];  ?></td>
										<td><?php echo $paymentVAL['payment_type'];  ?></td>
										<td><?php echo $paymentVAL['amount'];  ?></td>
									</tr>
						...
						<div class="row">
							...
							<div class="col-md-6 text-right" style="background-color: #31558F;color: white;min-height: 200px;">
								<br>
								<b><?=$this->lang('total')?></b>
								<h1><b><?php echo $paymentVAL['amount'];  ?></b></h1>
							</div>
						</div>
