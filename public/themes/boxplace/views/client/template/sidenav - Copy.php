      ...
      <nav class="navbar navbar-default small">
       <div class="container">
		...
		<div class="navbar-left pull-center">
		 <div class="collapse navbar-collapse" id="navbar-collapse-two" aria-expanded="false" style="height: 1px;">
		  <ul class="nav navbar-nav">
		   ...
		   <li class="<?=($data['url'] == 'jobs' ? ' active' : '')?>">
		    <a href="<?=$this->siteUrl()?>/<?=$this->client_url()?>/jobs"><?=$this->lang('jobs')?></a>
		   </li>


		   <!-- <li class="<?=($data['url'] == 'freelancers' ? ' active' : '')?>">
		    <a href="<?=$this->siteUrl()?>/<?=$this->client_url()?>/freelancers"><?=$this->lang('freelancers')?></a>
		   </li> -->
		   <!-- <li class="<?=($data['url'] == 'sended_jobs' ? ' active' : '')?>">
		    <a href="<?=$this->siteUrl()?>/<?=$this->client_url()?>/sended_jobs"><?=$this->lang('sended_jobs')?></a>
		   </li> -->
		   <li class="<?=($data['url'] == 'job_payments' ? ' active' : '')?>">
		    <a href="<?=$this->siteUrl()?>/<?=$this->client_url()?>/job_payments"><?=$this->lang('job_payments')?></a>
		   </li>

		   <li class="<?=($data['url'] == 'subscription' ? ' active' : '')?>">
		    <a href="<?=$this->siteUrl()?>/<?=$this->client_url()?>/subscription"><?=$this->lang('subscription')?></a>
		   </li>

		   <li class="<?=($data['url'] == 'token' ? ' active' : '')?>">
		    <a href="<?=$this->siteUrl()?>/<?=$this->client_url()?>/token"><?=$this->lang('token')?></a>
		   </li>
