		...
		<div class="navbar-left pull-center">
		 <div class="collapse navbar-collapse" id="navbar-collapse-two">
		  <ul class="nav navbar-nav">
		    ...
		    <a href="<?=$this->siteUrl()?>/<?=$this->freelancer_url()?>/jobs"><?=$this->lang('jobs')?></a>
		   </li>
		   <li class="<?=($data['url'] == 'info' ? ' active' : '')?>">
		    <a href="<?=$this->siteUrl()?>/<?=$this->freelancer_url()?>/info"><?=$this->lang('service_category')?></a>
		   </li>

		   <!-- <li class="<?=($data['url'] == 'subscription' ? ' active' : '')?>">
		    <a href="<?=$this->siteUrl()?>/<?=$this->freelancer_url()?>/subscription"><?=$this->lang('subscription')?></a>
		   </li> -->
