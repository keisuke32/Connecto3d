...
<html lang="en">
  ...
  <body>
        ...
        <!-- <script charset="UTF-8" src="//web.webpushs.com/js/push/4c6c1bc2f970401d5cda1bb32ecb0658_1.js" async></script>

                <script src="<?=$this->siteUrl()?>/<?=$this->themePath()?>/<?=$this->theme()?>/assets/plugins/sp-push/sp-push-worker-fb.js"></script> -->
</body>
</html>