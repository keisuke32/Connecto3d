...
?>
	 ...
	 Header
	 =============================================== -->	 
	 <header class="how-header  dashboard-header" >
      <div class="container">
       <div class="row">
	   
        <div class="col-lg-8 col-lg-offset-2">
         <div class="post-heading">
		  <h1><?=$this->lang('payment')?>.</h1>
         </div><!-- /.post-heading -->
        </div><!-- /.col-lg-8 -->
 	...
 	<div class="container">
 		...
 		<div class="row">
 			<div class="col-md-12 col-sm-12">
 				<br/>
 				<?php foreach ($data['Plan_DATA'] as $Plan_DATA) { ?>
 				...
 				<table class="table table-bordered">
 					...
 					<tbody>
 						<tr>
 							...
 							<td><?php echo $Plan_DATA['name'];?> &nbsp;<a href="<?php echo $this->siteUrl();?>/subscription/select_plan"  >change</a></td>
 							<td><?php echo $Plan_DATA['price'];?> (<?php echo $data['currency_code'];?>)</td>
 						</tr>
 					</tbody>
 				</table>
 					<?php } ?>
     ...
     =============================================== -->
      <?php if($data['settings']['paypal_active'] === "2"): ?> 
			 ...
			 <div class="payment-box">
			  ...
			  <div class="payment-bid">
			   <div class="payment-bid-inner">
				...
				<form action="<?=$this->siteUrl()?>/subscription/confirm_payment" method="post">
		   ...
		   <?php if($data['settings']['paystack_active'] === "2"): ?>
			 ...
			 <form id="paystack_form_resp"  action="<?=$this->siteUrl()?>/subscription/confirm_payment" method="POST">
