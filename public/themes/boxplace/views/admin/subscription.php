                  ...
                  <table id="example1" class="table table-bordered table-striped">
				    ...
				    foreach($data['subscription'] as $row) { ?>
				    	<tr>
				    		...
				    		<td>
				    			<a href="<?=$this->siteUrl()?>/admin/remove_subscription?id=<?=e($row['id'])?>" class="btn btn-danger btn-xs" data-toggle="tooltip" title="<?php echo $this->lang('delete');?>"><span class="fa fa-trash"></span></a>
				    		</td>
				    		<!-- <td>
