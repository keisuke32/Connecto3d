        ...
        <section class="content">	 	
		 ...
		 <div class="col-lg-12">	 		
                ...
                <div class="box-header text-right">
                	<a class="btn btn-info" href="<?php echo $this->siteUrl();?>/admin/adduser"><i class="fa fa-plus"></i> <?=$this->lang('new')?></a>
                </div><!-- /.box-header -->
                <div class="box-body">

                	<!-- <a href="<?php echo $this->siteUrl().'/admin/edit_service?id='; ?>" class="btn btn-success btn-xs" data-toggle="tooltip" title="<?php echo $this->lang('edit');?>"><span class="fa fa-edit"></span></a> -->
                 ...
                 <div class="table-responsive">
                  <table id="example1" class="table table-bordered table-striped">
				    ...
				    foreach($data['freelancers'] as $row) { 
