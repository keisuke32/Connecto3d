                 ...
                 <form role="form" method="post" action="<?=$this->siteUrl()?>/admin/adduser" > 
                  ...
                  <div class="form-group">	
                   ...
                   <div class="input-group">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="<?=$this->lang('full_name')?>" autocomplete="off"/>
                   </div>
                  </div> 
                  ...
                  <div class="form-group">	
                   ...
                   <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                    <input type="email" name="email" class="form-control" placeholder="<?=$this->lang('email')?>" autocomplete="off"/>
                   </div>
                  </div> 
