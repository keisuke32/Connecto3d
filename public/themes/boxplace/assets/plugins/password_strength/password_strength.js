...
;(function ( $, window, document, undefined ) {
    ...
    $.widget( "namespace.strength_meter" , {
        ...
        _create: function () {
            ...
            this.element.append('<input type="password" onkeyup="copycon(this.value)" onkeydown="copycon(this.value)" class="' + options.inputClass + '" "/><br/><br/>');
            this.element.append('<input type="text" onkeyup="copycon(this.value)" onkeydown="copycon(this.value)" class="' + options.inputClass + '" style="display:none"/>');
